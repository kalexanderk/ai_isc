...
if __name__ == '__main__':
    ...
    AP.add_argument("--have_imsave", type=int, default=1, help="If 0, save only .npz format which is needed for masks plotting.")
    ...
    main(device=parsed.device,
         ...
         dtype=dtype,
         scale_factor=parsed.scale_factor, have_imsave=parsed.have_imsave)
